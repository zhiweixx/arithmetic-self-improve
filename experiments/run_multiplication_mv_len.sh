...
for seed in 41 42 43 44 45; do
    ...
    do_train=True
    num_eval=128 
    CUDA_VISIBLE_DEVICES=0 WANDB_RUN_GROUP=mv_len WANDB_MODE=online python run_self_improve2.py \
        ...
        --self_improve_cache_loc='self_improve_data_mult_mv_len' \
        --seed=$seed \
        --architecture=llama \
...
for seed in 41 42 43 44 45; do
    ...
    si_path="self_improve_data_mult_mv_len/mult-COT-"
    CUDA_VISIBLE_DEVICES=0 WANDB_RUN_GROUP=mv_len WANDB_MODE=online python run_self_improve2.py \
        --majority_voting=True \
        --wandb_project='self-improve-multiplication' \
        --self_improve_cache_loc='self_improve_data_mult_mv_len' \
        ...
        \
        --save_total_limit=1 \
        --resume_from_checkpoint="out/mult_mv_len/round_${prev_round}-llama-384-6-6-1024-SI_round_${prev_round}-COT-digits-1_6_-1_6_-seed-${seed}" \
...
for seed in 41 42 43 44 45; do
    ...
    CUDA_VISIBLE_DEVICES=0 WANDB_RUN_GROUP=mv_len WANDB_MODE=online python run_self_improve2.py \
        ...
        \
        --save_total_limit=1 \
        --resume_from_checkpoint="out/mult_mv_len/round_${round}-llama-384-6-6-1024-SI_round_${round}-COT-digits-1_6_-1_6_-seed-${seed}" \
        --run_name="round_${round}" \
        --output_dir=out/mult_mv_len \
        --do_train=False \
        --do_eval=True \
...
for seed in 41 42 43 44 45; do
    ...
    do_train=True
    num_eval=128 
    CUDA_VISIBLE_DEVICES=0 WANDB_RUN_GROUP=mv_len WANDB_MODE='disabled' python run_self_improve2.py \
        --only_generate_data=True \
        --majority_voting=True \
        --filter_shorter_additional_data=True \
        --majority_vote_seeds='41,42,43,44,45' \
        ...
        \
        --save_total_limit=1 \
        --resume_from_checkpoint="out/mult_mv_len/round_2-llama-384-6-6-1024-SI_round_${prev_round}-COT-digits-1_6_-1_6_-seed-${seed}" \
        --run_name='round_2' \
        --output_dir=out/mult_mv_len \
        --do_train=$do_train \
        --do_eval=True \
...
for seed in 41 42 43 44 45; do
    ...
    CUDA_VISIBLE_DEVICES=0 WANDB_RUN_GROUP=mv_len WANDB_MODE='disabled' python run_self_improve2.py \
        ...
        \
        --save_total_limit=1 \
        --resume_from_checkpoint="out/mult_mv_len/round_3-llama-384-6-6-1024-SI_round_${prev_round}-COT-digits-1_6_-1_6_-seed-${seed}" \
        --run_name='round_3' \
        --output_dir=out/mult_mv_len \
        --do_train=$do_train \
        --do_eval=True \
...
for seed in 41 42 43 44 45; do
    ...
    CUDA_VISIBLE_DEVICES=0 WANDB_RUN_GROUP=mv_len WANDB_MODE='disabled' python run_self_improve2.py \
        ...
        \
        --save_total_limit=1 \
        --resume_from_checkpoint="out/mult_mv_len/round_4-llama-384-6-6-1024-SI_round_${prev_round}-COT-digits-1_6_-1_6_-seed-${seed}" \
        --run_name='round_3' \
        --output_dir=out/mult_mv_len \
        --do_train=$do_train \
        --do_eval=True \
...
for seed in 41 42 43 44 45; do
    ...
    CUDA_VISIBLE_DEVICES=0 WANDB_RUN_GROUP=mv_len WANDB_MODE='disabled' python run_self_improve2.py \
        ...
        \
        --save_total_limit=1 \
        --resume_from_checkpoint="out/mult_mv_len/round_5-llama-384-6-6-1024-SI_round_${prev_round}-COT-digits-1_6_-1_6_-seed-${seed}" \
        --run_name='round_3' \
        --output_dir=out/mult_mv_len \
        --do_train=$do_train \
        --do_eval=True \
...
for seed in 41 42 43 44 45; do
    ...
    CUDA_VISIBLE_DEVICES=0 WANDB_RUN_GROUP=mv_len WANDB_MODE='disabled' python run_self_improve2.py \
        ...
        \
        --save_total_limit=1 \
        --resume_from_checkpoint="out/mult_mv_len/round_6-llama-384-6-6-1024-SI_round_${prev_round}-COT-digits-1_6_-1_6_-seed-${seed}" \
        --run_name='round_3' \
        --output_dir=out/mult_mv_len \
        --do_train=$do_train \
        --do_eval=True \
